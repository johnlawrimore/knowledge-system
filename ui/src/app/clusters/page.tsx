  ...
  return (
    <div className={s.page}>
      <div className={s.header}>
        <h1 className={s.title}>Clusters</h1>
      </div>

      {loading ? (
        <div className={s.loading}>Loading clusters...</div>
      ) : clusters.length === 0 ? (
        <div className={s.empty}>No clusters found</div>
      ) : (
                ...
                {isExpanded && (
                  <div>
                    ...
                    <div className={s.detailSection}>
                      <div className={s.detailLabel}>Summary</div>
                      <InlineEdit
                        value={cl.summary}
                    ...
                    <div className={s.detailSection}>
                      <div className={s.detailLabel}>Reviewer Notes</div>
                      <InlineEdit
                    ...
                    {detail === null ? (
                      ...
                      <div className={s.detailSection}>
                        ...
                        {detail.claims.length === 0 ? (
                          <div className={s.detailValue}>No claims in this cluster</div>
                        ) : (
                    ...
                    {detail && detail.evidence_stats.length > 0 && (
                      <div className={s.detailSection}>
                        <div className={s.detailLabel}>Evidence Breakdown</div>
