  ...
  try {
    ...
    try {
      ...
      return NextResponse.json({
        ...
        expertise_notes: evalResults?.expertise_notes ?? null,
        authority_notes: evalResults?.authority_notes ?? null,
        reach_notes: evalResults?.reach_notes ?? null,
        reputation_notes: evalResults?.reputation_notes ?? null,
