...
docker exec -it knowledge-db mysql -uclaude -pclaude2026 knowledge  # MySQL shell

# Backup
docker exec knowledge-db mysqldump -uclaude -pclaude2026 knowledge > knowledge-backup.sql

# Restore
docker exec -i knowledge-db mysql -uclaude -pclaude2026 knowledge < knowledge-backup.sql
